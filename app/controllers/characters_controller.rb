class CharactersController < ApplicationController
    def create
        ...
        @character = @user.characters.create(name: name, status: position, exp: experience, gold: money, race: races.sample())
    ...
    def delete
        ...
        if @characters.count > 0 then
            Character.destroy(@characters.sample.id)
        end
        redirect_to '/play'
    end
end